      ...
      <div class="card-body info-table">
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">
            {{ balance | sbercoin }} SBER
            <span v-if="unconfirmed !== '0' && staking !== '0'">
              ({{ unconfirmed | sbercoin }} SBER {{ $t('address.unconfirmed') }},
              {{ staking | sbercoin }} SBER {{ $t('address.staking') }})
            </span>
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">{{ totalReceived | sbercoin }} SBER</div>
        </div>
        <div class="columns">
          <div class="column info-title">{{ $t('address.total_sent') }}</div>
          <div class="column info-value monospace">{{ totalSent | sbercoin }} SBER</div>
        </div>
